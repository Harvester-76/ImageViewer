...
public enum GalleryConfigurationItem {
    ...
    ///Option to set the Activity button type.
    case activityButtonMode(ButtonMode)
    ...
    /// Layout behaviour for the Activity button.
    case activityLayout(ButtonLayout)
    ...
    /// Displacment view will require original image size from datasource when is being presented.
    case displacementRequiresOriginalSize(Bool)
